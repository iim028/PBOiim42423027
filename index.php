...
<body>
  ...
  <center>
    ...
    <img src="gambar/IMG_3563.JPG" style="width:500px; height:600px;">
...
class Orang {
    ...
    public function __construct($nama, $tinggi, $warna) {
        ...
        $this->tinggi = $tinggi;
        $this->warna = $warna;
        echo "mahasiswa tersebut bernama {$this->nama}, Tinggi badan {$this->tinggi} dan berwarna {$this->warna}<br>";
    }

    public function __destruct() {
        // Destructor code can remain empty if not needed
    }
}
